angular.module('baabtra').controller('MenteeevaluationCtrl',['$scope','$rootScope','viewBatches','$stateParams','$alert','assignCourseMaterial','attendenceService','$aside',function($scope,$rootScope,viewBatches,$stateParams,$alert,assignCourseMaterial,attendenceService,$aside){
