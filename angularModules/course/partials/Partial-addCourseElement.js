angular.module('baabtra').controller('AddcourseelementCtrl',['$scope','addCourseElementService','$modal','$alert',function($scope,addCourseElementService,$modal,$alert){
...
addCourseElementService.FnGetExitCriteria($scope);
	...
	$scope.saveCourseElement = function(course_element_form){
		...
		$scope.courseElement.courseElementData.exitCriteria[$scope.sel.exitCriteria.Name]=$scope.courseElement.exitCriteria.config;
...
$scope.AddCourseElementsText = function(){
