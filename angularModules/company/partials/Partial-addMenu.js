angular.module('baabtra').controller('AddmenuCtrl',['$scope','commonService','$alert','$modal','$rootScope','addMenu','localStorageService',function ($scope,commonService,$alert,$modal,$rootScope,addMenu,localStorageService){
