angular.module('baabtra').directive('epubreader', function() {
	return {
			restrict: "E",
			scope: {
				src: '@'
			},
			templateUrl: 'angularModules/courseElementFields/epubreader/reader.html',

			controller: function($scope, $rootScope, $location, $q, gAnalytics, $sce){
				

				console.log($scope.src);
				if($scope.src){
					$scope.neWsrc = $sce.trustAsResourceUrl($scope.src);
				}
