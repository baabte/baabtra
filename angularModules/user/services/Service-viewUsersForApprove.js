...
this.fnApproveUserRequest = function(userId, statusType, rmId, companyId)//To Load Mentees For Approve
      {
        var promise = $http({
          method: 'post',
          url: bbConfig.BWS+'ApproveUserRequest/',
          data:{userId:userId, statusType:statusType, rmId:rmId, companyId:companyId},
          contentType:'application/json; charset=UTF-8',
        });
        return promise;
      };
