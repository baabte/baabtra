...
// ----------- branch loader -----------
  ...
  $templateCache.put('angular-form-gen/field-templates/default/branchLoader.ng.html', '<paper-input-decorator  label="{{field.schema.displayName}}" floatinglabel><branch-loader xt-validate  fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-disabled=\"isDisabled(field.schema)\"></branch-loader></paper-input-decorator>');
