...
angular.module('fg').run(['$templateCache','courseElementFieldsManaging','fgConfig','FgField', function($templateCache,courseElementFieldsManaging,fgConfig,FgField){
  ...
  $templateCache.put('angular-form-gen/field-templates/default/email.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><input   class=\"form-control\" fg-custom-attributes fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\" ng-disabled=\"isDisabled(field.schema)\"></paper-input-decorator>');
  // <paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><input required xt-validate  class="form-control" fg-field-input="" type="text" id="{{ field.$_id }}" title="{{ field.schema.tooltip }}" tabindex="{{ tabIndex }}" placeholder="{{ field.schema.placeholder }}" ng-model="form.data[field.schema.name]" ng-required="field.schema.validation.required" ng-pattern="/{{ field.schema.validation.pattern }}/" ng-disabled="isDisabled(field.schema)"></paper-input-decorator>
  ...
  $templateCache.put('angular-form-gen/field-templates/default/number.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><input previewKey=\"payment-checkpoint\" fg-custom-attributes class=\"form-control\" fg-field-input=\"\" fg-input-number=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" min=\"{{ field.schema.validation.min }}\" max=\"{{ field.schema.validation.max }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\"></paper-input-decorator>');
  $templateCache.put('angular-form-gen/field-templates/default/password.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><input  class=\"form-control\" fg-custom-attributes fg-field-input=\"\" type=\"password\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"{{ field.schema.validation.pattern }}\" ng-disabled=\"isDisabled(field.schema)\"></paper-input-decorator>');
  ...
  $templateCache.put('angular-form-gen/field-templates/default/selectlist.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><select   class=\"form-control\" fg-custom-attributes fg-field-input=\"\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" tabindex=\"{{ tabIndex }}\"><option ng-repeat=\"option in field.schema.options\" value=\"{{ option.value }}\" ng-selected=\"form.data[field.schema.name] === option.value\">{{ option.text || option.value }}</option></select></paper-input-decorator>');
  $templateCache.put('angular-form-gen/field-templates/default/text.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><input   class=\"form-control\" fg-custom-attributes fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\" ng-disabled=\"isDisabled(field.schema)\"></paper-input-decorator>');
  $templateCache.put('angular-form-gen/field-templates/default/textarea.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><textarea   class=\"form-control\" fg-custom-attributes fg-field-input=\"\" fg-placeholder=\"field.schema.placeholder\" ng-model=\"form.data[field.schema.name]\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\">\n' +
    '</textarea></paper-input-decorator>');
  ...
  $templateCache.put('angular-form-gen/form/field/field.ng.html', '<div ng-include=\"renderInfo.templateUrl\"></div>');
  ...
  $templateCache.put('angular-form-gen/field-templates/default/date.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><input type=\"text\" class=\"form-control\" fg-custom-attributes  placement=\"bottom-right\" data-date-format=\"dd-MM-yyyy\" data-date-type=\"date\" data-autoclose=\"true\"  data-min-date=\"02/10/86\" bs-datepicker=\"\" autocomplete=\"off\"fg-field-input=\"\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\" ng-disabled=\"isDisabled(field.schema)\"></paper-input-decorator>');
...
// ----------- branch loader -----------
  ...
  $templateCache.put('angular-form-gen/field-templates/default/branchloader.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><branch-loader fg-custom-attributes fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-minlength=\"{{ field.schema.validation.minlength }}\" ng-maxlength=\"{{ field.schema.validation.maxlength }}\" ng-pattern=\"/{{ field.schema.validation.pattern }}/\" ng-disabled=\"isDisabled(field.schema)\"></branch-loader></paper-input-decorator>');
...
// ----------- course loader -----------
  ...
  $templateCache.put('angular-form-gen/field-templates/default/courseloader.ng.html', '<paper-input-decorator fields-options-button label="{{field.schema.displayName}}" floatinglabel><course-loader  fg-field-input=\"\" type=\"text\" id=\"{{ field.$_id }}\" title=\"{{ field.schema.tooltip }}\" tabindex=\"{{ tabIndex }}\" placeholder=\"{{ field.schema.placeholder }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" ng-disabled=\"isDisabled(field.schema)\"></course-loader></paper-input-decorator>');
