...
.run(function(gettextCatalog, $rootScope){  
  ...
  var unbindThis = $rootScope.$watch(function(){ return $rootScope.userinfo; }, function(){
    ...
    if(!angular.equals($rootScope.userinfo.ActiveUserData.roleMappingObj.Preferedlanguage, undefined)){
        var preLang = $rootScope.userinfo.ActiveUserData.roleMappingObj.Preferedlanguage.langCode;
    }
    else{
