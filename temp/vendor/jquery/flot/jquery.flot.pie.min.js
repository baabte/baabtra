  ...
  function r(r) {
    ...
    function d(t) {
      ...
      for (var a = 0; a < t.length; ++a) {
        var f = t[a].data;
        e.isArray(f) && f.length == 1 && (f = f[0]), e.isArray(f) ? !isNaN(parseFloat(f[1])) && isFinite(f[1]) ? f[1] = +f[1] : f[1] = 0 : !isNaN(parseFloat(f)) && isFinite(f) ? f = [
          1,
          +f
        ] : f = [
          1,
    ...
    function v(r, s) {
      ...
      var v = r.getData(), g = 0;
      do
        g > 0 && (u *= n), g += 1, y(), i.series.pie.tilt <= 0.8 && b();
      while (!w() && g < t);
