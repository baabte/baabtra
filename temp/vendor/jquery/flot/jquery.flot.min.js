...
(function (e) {
  e.color = {}, e.color.make = function (t, n, r, i) {
    ...
    return s == 'transparent' ? i(255, 255, 255, 0) : (r = t[s] || [
      0,
      0,
      0
    ], i(r[0], r[1], r[2]));
  ...
  function r(t, r, s, o) {
    ...
    function x(n) {
      e.extend(!0, a, n), n && n.colors && (a.colors = n.colors), a.xaxis.color == null && (a.xaxis.color = e.color.parse(a.grid.color).scale('a', 0.22).toString()), a.yaxis.color == null && (a.yaxis.color = e.color.parse(a.grid.color).scale('a', 0.22).toString()), a.xaxis.tickColor == null && (a.xaxis.tickColor = a.grid.tickColor || a.xaxis.color), a.yaxis.tickColor == null && (a.yaxis.tickColor = a.grid.tickColor || a.yaxis.color), a.grid.borderColor == null && (a.grid.borderColor = a.grid.color), a.grid.tickColor == null && (a.grid.tickColor = e.color.parse(a.grid.color).scale('a', 0.22).toString());
      var r, i, s, o = {
          style: t.css('font-style'),
          size: Math.round(0.8 * (+t.css('font-size').replace('px', '') || 13)),
    ...
    function M() {
      ...
      for (r = 0; r < t; r++)
        s = e.color.parse(f[r % l] || '#666'), r % l == 0 && r && (c >= 0 ? c < 0.5 ? c = -c - 0.2 : c = 0 : c = -c), o[r] = s.scale('rgb', 1 + c);
      var h = 0, p;
      for (r = 0; r < u.length; ++r) {
    ...
    function _() {
      ...
      for (i = 0; i < u.length; ++i)
        l = u[i], l.datapoints = { points: [] }, E(b.processRawData, [
          l,
          l.data,
          l.datapoints
        ]);
    ...
    function Q() {
      ...
      for (var l = 0; l < n.length; ++l) {
        ...
        if (!c.show || c.ticks.length == 0)
          continue;
        h.lineWidth = 1, c.direction == 'x' ? (v = 0, d == 'full' ? b = c.position == 'top' ? 0 : y : b = p.top - m.top + (c.position == 'top' ? p.height : 0)) : (b = 0, d == 'full' ? v = c.position == 'left' ? 0 : g : v = p.left - m.left + (c.position == 'left' ? p.width : 0)), c.innermost || (h.strokeStyle = c.options.color, h.beginPath(), E = S = 0, c.direction == 'x' ? E = g + 1 : S = y + 1, h.lineWidth == 1 && (c.direction == 'x' ? b = Math.floor(b) + 0.5 : v = Math.floor(v) + 0.5), h.moveTo(v, b), h.lineTo(v + E, b + S), h.stroke()), h.strokeStyle = c.options.tickColor, h.beginPath();
        for (t = 0; t < c.ticks.length; ++t) {
          var x = c.ticks[t].v;
          E = S = 0;
          if (isNaN(x) || x < c.min || x > c.max || d == 'full' && (typeof r == 'object' && r[c.position] > 0 || r > 0) && (x == c.min || x == c.max))
            continue;
          c.direction == 'x' ? (v = c.p2c(x), S = d == 'full' ? -y : d, c.position == 'top' && (S = -S)) : (b = c.p2c(x), E = d == 'full' ? -g : d, c.position == 'left' && (E = -E)), h.lineWidth == 1 && (c.direction == 'x' ? v = Math.floor(v) + 0.5 : b = Math.floor(b) + 0.5), h.moveTo(v, b), h.lineTo(v + E, b + S);
        }
        h.stroke();
      }
    ...
    function it() {
      ...
      for (var l = 0; l < u.length; ++l)
        o = u[l], o.label && (f = s ? s(o.label, o) : o.label, f && r.push({
          label: f,
          color: o.color
        }));
      if (a.legend.sorted)
      ...
      if (a.legend.container != null)
        ...
        g[0] == null && (g = [
          g,
          g
        ]), v.charAt(0) == 'n' ? d += 'top:' + (g[1] + m.top) + 'px;' : v.charAt(0) == 's' && (d += 'bottom:' + (g[1] + m.bottom) + 'px;'), v.charAt(1) == 'e' ? d += 'right:' + (g[0] + m.right) + 'px;' : v.charAt(1) == 'w' && (d += 'left:' + (g[0] + m.left) + 'px;');
    ...
    function gt(t, n) {
      var r = n[0], i = n[1], s = t.xaxis, o = t.yaxis, u = typeof t.highlightColor == 'string' ? t.highlightColor : e.color.parse(t.color).scale('a', 0.5).toString();
    ...
    function yt(t, n) {
      var r = typeof t.highlightColor == 'string' ? t.highlightColor : e.color.parse(t.color).scale('a', 0.5).toString(), i = r, s = t.bars.align == 'left' ? 0 : -t.bars.barWidth / 2;
