  ...
  b['true'] = a, function (a, b) {
    ...
    function f(a, c) {
      ...
      for (j.last = function () {
        ...
        if (h = !0, j.last() && C[j.last()])
          a = a.replace(new RegExp('(.*)<\\s*\\/\\s*' + j.last() + '[^>]*>', 'i'), function (a, b) {
        ...
        if (a == k)
          throw l('badparse', 'The sanitizer was unable to parse the following block of html: {0}', a);
        k = a;
      }
      e();
    }
    ...
    b.module('ngSanitize', []).provider('$sanitize', c), b.module('ngSanitize').filter('linky', [
      '$sanitize',
      function (a) {
