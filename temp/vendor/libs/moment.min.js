...
(function (a) {
  ...
  function l(a) {
    ...
    this._milliseconds = +k + 1000 * j + 60000 * i + 3600000 * h, this._days = +g + 7 * f, this._months = +e + 3 * d + 12 * c, this._data = {}, this._locale = tb.localeData(), this._bubble();
  }
  function m(a, b) {
    for (var d in b)
      c(b, d) && (a[d] = b[d]);
  ...
  pc.DDDD = h(pc.DDD, 3), m(j.prototype, {
    ...
    monthsParse: function (a) {
      ...
      for (this._monthsParse || (this._monthsParse = []), b = 0; 12 > b; b++)
        if (this._monthsParse[b] || (c = tb.utc([
            2000,
            b
  ...
  tb.normalizeUnits = function (a) {
    ...
    diff: function (a, b, c) {
      var d, e, f, g = K(a, this), h = 60000 * (this.zone() - g.zone());
      return b = x(b), 'year' === b || 'month' === b ? (d = 43200000 * (this.daysInMonth() + g.daysInMonth()), e = 12 * (this.year() - g.year()) + (this.month() - g.month()), f = this - tb(this).startOf('month') - (g - tb(g).startOf('month')), f -= 60000 * (this.zone() - tb(this).startOf('month').zone() - (g.zone() - tb(g).startOf('month').zone())), e += f / d, 'year' === b && (e /= 12)) : (d = this - g, e = 'second' === b ? d / 1000 : 'minute' === b ? d / 60000 : 'hour' === b ? d / 3600000 : 'day' === b ? (d - h) / 86400000 : 'week' === b ? (d - h) / 604800000 : d), c ? e : o(e);
    },
    from: function (a, b) {
      return tb.duration({
        to: this,
    ...
    _bubble: function () {
      ...
      g.milliseconds = d % 1000, a = o(d / 1000), g.seconds = a % 60, b = o(a / 60), g.minutes = b % 60, c = o(b / 60), g.hours = c % 24, e += o(c / 24), h = o(pb(e)), e -= o(qb(h)), f += o(e / 30), e %= 30, h += o(f / 12), f %= 12, g.days = e, g.months = f, g.years = h;
    },
    abs: function () {
    ...
    as: function (a) {
      ...
      if (a = x(a), 'month' === a || 'year' === a)
        return b = this._days + this._milliseconds / 86400000, c = this._months + 12 * pb(b), 'month' === a ? c : c / 12;
